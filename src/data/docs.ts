...
export const navItems: NavItem[] = [
  ...
  { id: "update-2",     label: "3-2. 소스코드 저장",       icon: "git-commit" },
  { id: "update-3",     label: "3-3. 사이트 재배포",       icon: "upload-cloud" },
  { id: "update-tip",   label: "3-4. 버전 관리 팁",        icon: "tag" },
  { id: "cicd",         label: "PART 4 · CI/CD 자동화",   icon: "workflow" },
  { id: "cicd-1",       label: "4-1. 수동 vs 자동 비교",   icon: "git-compare" },
  { id: "cicd-2",       label: "4-2. workflow 파일 작성",  icon: "file-code-2" },
  { id: "cicd-3",       label: "4-3. GitHub Pages 설정",   icon: "shield-check" },
  { id: "cicd-4",       label: "4-4. 배포 확인",           icon: "check-circle" },
